...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/seunggeun/Desktop/서강대학교/인공지능 종합설계/인공지능종합설계_팀플/ComprehensiveDesignOfAI-TeamProject'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/seunggeun/Desktop/서강대학교/인공지능 종합설계/인공지능종합설계_팀플/ComprehensiveDesignOfAI-TeamProject/bin/deactivate.nu'
